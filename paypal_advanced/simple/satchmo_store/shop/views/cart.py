...
def display(request, cart=None, error_message='', default_view_tax=None):
    ...
    #print contact.billing_address.street1,"contact contact"
    #print contact.billing_address.state,"contact contact"
    #print contact.billing_address.city,"contact contact"
    #print contact.billing_address.postal_code,"contact contact"
